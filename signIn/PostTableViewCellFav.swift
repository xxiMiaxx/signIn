...
class PostTableViewCellFav: UITableViewCell {
   ...
   // @IBOutlet weak var btnHeart: UIButton!
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        favBtn.addTarget(self, action: #selector(handleMarkAsUnFavorite), for: .touchUpInside)
   ...
   func viewDidLoad() {
    ...
    @objc private func handleMarkAsUnFavorite()  {
